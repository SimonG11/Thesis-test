...
def main():
    ...
    # We take a random permutation from the generated instance,
    # decode it into a schedule and visualize it.
    ...
    # This manually defined schedule shows the structure of schedule data.
    # You can modify the values as needed to test rules, constraints, etc.
    print("\n=== Manual Schedule Example ===")
    ...
    # 4. Define common parameter settings for algorithms.
